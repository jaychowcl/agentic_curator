...
| `ontology-harmonizer` | [Ontology Harmonizer](codebase.md#ontology-harmonizer) | Placeholder ontology harmonizer curator, public harmonize method, configurable target paths, editable target extraction, path specs, extraction modes, and stable envelope output. | OntologyHarmonizer, harmonize, publication_text, metadata, title, ontology_frameworks, target_paths, DEFAULT_TARGET_PATHS, matches, targets, start_paths, path specs, scalar, tag_value, container_value, field_path, label_path, JSON Pointer, placeholder, curator |

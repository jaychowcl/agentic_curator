...
| `ontology-search-judge` | [Ontology Search Judge](codebase.md#ontology-harmonizer) | Local ambiguity and FTS judging, two-stage OLS validation, grounded web ID resolution, and protected enrichment. | lookup_llm_judge, FTS judge, search_llm_judge, judged identity, identifier enrichment, RequestPolicy, retry, restricted OLS, unrestricted OLS, Gemini grounded search, fail closed |

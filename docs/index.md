...
| `prompts` | [Prompts](codebase.md#prompts) | Per-curator packaged Markdown prompts, evidence/judge prompt roles, ontology framework assignment prompt, and local fibrosis theme example. | prompts, curator package, evidence_extraction, judge_evidence, assign_onto_framework, theme.md, fibrosis |

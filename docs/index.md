...
| `ontology-harmonizer` | [Ontology Harmonizer](codebase.md#ontology-harmonizer) | Placeholder ontology harmonizer curator, public harmonize method, editable target extraction, and stable envelope output. | OntologyHarmonizer, harmonize, publication_text, metadata, title, ontology_frameworks, matches, targets, field_path, label_path, JSON Pointer, placeholder, curator |

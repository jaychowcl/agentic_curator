...
| `runtime-and-packaging` | [Runtime And Packaging](codebase.md#runtime-and-packaging) | Packaging metadata, requirements file, dependencies, console scripts, package data, and editable install. | pyproject, requirements.txt, setuptools, dependencies, google-genai, anthropic, rdflib, requests, pytest, package-data, cli_thematic_reviewer, cli_ontology_harmonizer |
...
| `common-commands` | [Common Commands](codebase.md#common-commands) | Frequently used install, requirements install, test, CLI, ontology CLI, and fixture commands. | commands, install, requirements.txt, pytest, CLI, cli_thematic_reviewer, cli_ontology_harmonizer, fixtures |

...
| --- | --- | --- | --- |
| `project-purpose-and-layout` | [Project Purpose And Layout](codebase.md#project-purpose-and-layout) | Repository purpose, tracked layout, README user guide, authors policy, citation location, and ignored local artifacts. | layout, purpose, README, quickstart, installation, guide, inputs outputs, code flow, docs links, authors, LICENSE, ignored, .dev, .env, .vscode |

...
| `ontology-harmonizer` | [Ontology Harmonizer](codebase.md#ontology-harmonizer) | Dataset-level compound-target checking, fixed local exact/FTS, semantic RAG, optional hierarchy expansion, OLS, label promotion, validated field assignment, and MINiML application. | OntologyHarmonizer, target checker, compound label, additions, provenance, local_rag_ols, metadata_context, lookup_label, lookup_rag_label, rag_hierarchy, harmonize_label, harmonize_field, assign_field, miniml_json, OLS4, no_match, false |

...
| `ontology-sqlite-index` | [Ontology SQLite And Semantic Index](codebase.md#ontology-harmonizer) | Bounded-memory OWL/JSON streaming, exact/FTS5 SQLite lookup, Gemini embeddings, sequential multi-framework USearch partitions, field registry, and caches. | SQLite, ijson, USearch, GeminiEmbeddingProvider, gemini-embedding-001, lookup_rag, lookup_rag_many, build_rag_index, memory map, cached URL framework, vector, semantic, FTS5, field registry |
| `ontology-search-judge` | [Ontology Judge Context](codebase.md#ontology-harmonizer) | Context contracts, similarity thresholds, balanced semantic candidates, and accept, fall-through, and terminal-rejection semantics. | LLM context, calls per target, 0 to 4 calls, lookup judge, semantic judge, RAG threshold, 0.5, two per ontology, balanced candidates, OLS judge, no_match, false, identifier enrichment |

...
| `ontology-search-judge` | [Ontology Search Judge](codebase.md#ontology-harmonizer) | Two-stage LLM validation of restricted and unrestricted OLS candidates with grounded web evidence. | search_llm_judge, judge_search_results, judge_search.md, restricted OLS, unrestricted OLS, Gemini grounded search, false, fail closed, search_llm_judgements |

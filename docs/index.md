...
| `prompts` | [Prompts](codebase.md#prompts) | Per-curator packaged Markdown prompts and the local fibrosis theme example. | prompts, curator package, evidence_extraction, judge_evidence, theme.md, fibrosis |

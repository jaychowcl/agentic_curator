...
| `ontology-harmonizer` | [Ontology Harmonizer](codebase.md#ontology-harmonizer) | Ontology harmonizer curator, public harmonize method, compact metadata context, per-target LLM call counts, OntoStore eager cache/lookup/downloads, field harmonization, strategies, and target extraction/application. | OntologyHarmonizer, metadata_context, 500 characters, publication_context, LLM calls per target, lookup_label, assign_field, assign_onto_framework, harmonize_label, miniml_json, OntoStore, cache_all, OntologyCacheError, FTS5, OLS4, websearch, target paths |
| `ontology-sqlite-index` | [Ontology SQLite Index](codebase.md#ontology-harmonizer) | Bounded-memory OWL streaming, legacy JSON import, shared exact and FTS5 index, persistent field registry, and external response cache. | SQLite, staging, streaming, source_kind, force_frameworks, FTS5, exact, synonyms, field registry, CRUD, response cache, sqlite_path, ontologies.sqlite3, lookup |
...
| `reviewer-workflow` | [Reviewer Workflow](codebase.md#reviewer-workflow) | Direct whole-publication, criterion-based accession review, derived judgements, compact metadata context, and the legacy evidence-then-judgement strategy. | workflow, direct, accession_assessments, human_samples, transcriptomics_assay, established_fibrosis, accession_linkage, derived judgement, compact MINiML, evidence_then_judgement, accessions_to_remove, response_schema, prompt, metadata, JSON |
...
| `prompts` | [Prompts](codebase.md#prompts) | Header-free packaged model prompts, evidence/judge roles, ontology framework, lookup judgement, field assignment, and local fibrosis theme example. | prompts, no author headers, model context, curator package, evidence_extraction, judge_evidence, assign_onto_framework, judge_lookup, assign_field, theme.md, fibrosis |

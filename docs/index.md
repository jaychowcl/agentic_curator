...
| `ontology-harmonizer` | [Ontology Harmonizer](codebase.md#ontology-harmonizer) | Fixed local exact/FTS, semantic RAG, OLS, label promotion, and field workflow with MINiML application. | OntologyHarmonizer, local_rag_ols, metadata_context, lookup_label, lookup_rag_label, harmonize_label, harmonize_field, miniml_json, OLS4, no_match, false |
| `ontology-sqlite-index` | [Ontology SQLite And Semantic Index](codebase.md#ontology-harmonizer) | Bounded-memory OWL streaming, exact/FTS5 SQLite lookup, Gemini embeddings, persistent USearch partitions, field registry, and caches. | SQLite, USearch, GeminiEmbeddingProvider, gemini-embedding-001, lookup_rag, build_rag_index, vector, semantic, FTS5, field registry |
| `ontology-search-judge` | [Ontology Judge Context](codebase.md#ontology-harmonizer) | Context contracts and accept, fall-through, and terminal-rejection semantics for local, semantic, and OLS judges. | LLM context, calls per target, 0 to 4 calls, lookup judge, semantic judge, OLS judge, no_match, false, identifier enrichment |

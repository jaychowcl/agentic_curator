...
| `reviewer-workflow` | [Reviewer Workflow](codebase.md#reviewer-workflow) | Direct whole-publication review, accession exclusion traces, and the legacy evidence-then-judgement strategy. | workflow, direct, evidence_then_judgement, accessions_to_remove, evidence, judgement, response_schema, prompt, metadata, JSON |

...
| `ontology-harmonizer` | [Ontology Harmonizer](codebase.md#ontology-harmonizer) | Placeholder ontology harmonizer curator, public harmonize method, and stable envelope output. | OntologyHarmonizer, harmonize, publication_text, metadata, title, ontology_frameworks, matches, placeholder, curator |

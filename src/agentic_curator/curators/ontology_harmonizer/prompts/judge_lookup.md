...
- decision: the selected hit id, "no_match" when none of the supplied candidates
  fit but the target may be harmonizable elsewhere, or "false" to skip the target.
